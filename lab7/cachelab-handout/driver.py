#!/usr//bin/python
#
# driver-csim-only.py - The driver tests the correctness of the student's cache
#     simulator only. It uses ./test-csim to check the correctness of the
#     simulator.
#
import subprocess
import re
...
def main():
    ...
    if autograde:
        autoresult="%.1f:%d:%d:%d" % (total_score, 0, 0, 0)
